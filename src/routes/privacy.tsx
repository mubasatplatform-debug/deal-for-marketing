...
const sections: { title: string; body: string[]; id?: string }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "رموز التحقق المرسلة إلى الجوال عبر واتساب أو الرسائل النصية (للدخول بخطوتين، ولتأكيد رقم العميل عند الحجز) يرسلها ويتحقق منها مزوّد الاتصالات Twilio، فيصله رقم الجوال لهذا الغرض فقط. لا نحفظ الرموز نفسها، ونحفظ رقم الدخول بخطوتين ما دام مفعّلًا.",
      "المكالمات التي يجريها المكتب من خلال المنصة يوصلها مزوّد الاتصالات Twilio، وإذا فعّل المكتب تسجيل المكالمات تُسجَّل (مع تنبيه الطرف الآخر قبل بدء المكالمة) وتُحفظ التسجيلات لدى Twilio، وتُفرَّغ نصيًا عبر OpenAI ويُلخَّص محتواها لاستخدام المكتب فقط.",
