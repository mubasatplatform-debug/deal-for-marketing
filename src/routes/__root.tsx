...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cairo:wght@400;600;700;800&family=Great+Vibes&family=Manrope:wght@400;500;600;700;800&family=Roboto+Slab:wght@300;400;500;600;700&display=swap",
      },
    ],
  }),
  component: () => (
