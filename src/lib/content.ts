...
export const quotes = [
  {
    text: "أبو فيصل لا يجمّل الغلط. يكره الخطأ، فيخوض الصعب حتى يصير الطريق واضحًا لغيره. تاجر إذا لزم الربح، دكتور إذا لزم التشخيص، محامي إذا لزم الحق — وشباب نار، لأن الإبداع لا يعيش في مكتب بارد.",
    by: "خالد العنزي — أبو فيصل",
  },
  {
    text: "المعيار عندي أنا. من رضي بأقل… فليعمل في مكان آخر. ومن أحب المعيار، يبدع.",
    by: "خالد العنزي — أبو فيصل",
  },
  {
    text: "نؤمن في ديل أن التأثير الحقيقي لا يأتي صدفة؛ بل تصنعه فكرة واضحة، وإبداع متجدد، وتنفيذ لا يسامح الخطأ.",
    by: "خالد العنزي",
  },
] as const;
