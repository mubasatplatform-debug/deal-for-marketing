...
export const lawAtlas = [
  {
    image: "/images/law-site.jpg",
    n: "01",
    title: "موقع المكتب وصفحة الثبوت",
    body: "أول ما يراه العميل: حضور يليق بالمهنة، وترخيص وعضوية وخبرة في صفحة واحدة. الثقة تُبنى قبل أن يُحجز الموعد.",
  },
  {
    image: "/images/law-book.jpg",
    n: "02",
    title: "الحجز بالذكاء الاصطناعي",
    body: "العميل يختار الوقت، والنظام يمنع التعارض مع جلسة أو موعد قائم. بلا تنسيق يدوي، وبلا رسالة «متى تفضّل؟».",
  },
  {
    image: "/images/law-crm.jpg",
    n: "03",
    title: "CRM — ملف العميل الحي",
    body: "CRM معناها: كل ما يخص هذا الموكل في شاشة واحدة. الرسائل، العقود، المواعيد، القضية. السياق لا يضيع إذا تغيّر الموظف.",
  },
  {
    image: "/images/law-staff.jpg",
    n: "04",
    title: "الموظفون وإدارة المكتب",
    body: "صلاحيات، مهام اليوم، ومن في المحكمة ومن على المكتب. الإدارة هنا فعل يومي — لا تقرير يُقرأ في آخر الأسبوع.",
  },
  {
    image: "/images/law-doc.jpg",
    n: "05",
    title: "تحليل العقود",
    body: "يقرأ العقد، يؤشّر على الغامض والخطر، ويعيد الصياغة بلغة أوضح. المحامي يعتمد — والآلة لا تُوقّع.",
  },
  {
    image: "/images/law-najiz.jpg",
    n: "06",
    title: "القضايا والرفع إلى ناجز",
    body: "الذكاء يرتّب الوقائع واللائحة والمرفقات. أنت تعتمد، ثم يُرفع المسار إلى ناجز: قيد الإعداد، جاهز، رُفع، وله رقم معاملة تتابعه من مكتبك.",
  },
  {
    image: "/images/law-video.jpg",
    n: "07",
    title: "الاستشارة بالفيديو داخل المنصة",
    body: "الجلسة من موقعك، لا من منصة خارجة. سرية، موعدها من النظام، ومذكرتها تُحفظ في ملف العميل نفسه.",
  },
] as const;
