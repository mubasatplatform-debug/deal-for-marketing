...
export const services = [
  ...
  },
  {
    ...
    n: "04",
    title: "الدفع المبسط",
    body: "من منصة مبسط: رابط دفع، فاتورة، وتحصيل. فتحة مالية جاهزة — بلا تعقيد بوابة.",
  },
  {
    slug: "brand",
    n: "05",
...
export const payAtlas = [
  {
    ...
    n: "01",
    title: "التحصيل",
    body: "ما دخل اليوم، الروابط المفتوحة، وما ينتظر الدفع. شاشة واحدة للمالية.",
  },
  {
    image: "/images/pay-pay.jpg",
    n: "02",
    title: "رابط الدفع المبسط",
    body: "من منصة مبسط: المبلغ، الفاتورة، وادفع الآن. مدى أو آبل باي — بلا تعقيد بوابة.",
  },
  {
    image: "/images/pay-bills.jpg",
    n: "03",
    title: "الفواتير",
    body: "رقم، عميل، مبلغ، حالة. المفتوحة والمدفوعة في مكانها.",
  },
] as const;
