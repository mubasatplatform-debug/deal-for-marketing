...
export const SCOPE_INFO: readonly ScopeInfo[] = [
  ...
  {
    scope: "law:read",
    label: "قراءة بيانات مكتب المحامي",
    body: "يقرأ عملاء مكتبك وقضاياه وجلساته ومهامه وتقاريره، بحدود دورك في المكتب. لمساعدات الذكاء الاصطناعي عبر MCP.",
    admin: false,
    write: false,
  },
  {
    scope: "law:write",
    label: "تعديل بيانات مكتب المحامي",
    body: "يضيف ويعدّل العملاء والقضايا والجلسات والمهام والمواعيد باسمك وبحدود دورك (بدون حذف). تُسجَّل كل عملية في سجل المساعد.",
    admin: false,
    write: true,
  },
  {
