...
const MESSAGES: Record<string, string> = {
  ...
  plan_too_small: "عدد أعضاء المكتب ودعواته المعلّقة أكبر من مقاعد هذه الخطة. أزل أعضاء أو ألغِ دعوات، أو اختر خطة أكبر.",
  ...
  tax_profile: "أكمل بيانات الفوترة الضريبية للمكتب (الاسم النظامي والرقم الضريبي) من الإعدادات قبل إصدار الفواتير.",
  credit_exceeded: "مبلغ الإشعار الدائن أكبر من المتبقي القابل للإشعار في الفاتورة الأصلية.",
  has_invoices: "صدرت فواتير ضريبية لهذا السجل، والفواتير سجلات نظامية لا تُحذف، لذا لا يمكن حذفه.",
  ai_limit: "وصل المكتب إلى الحد اليومي لاستخدام المساعد. حاول غدًا.",
  ai_unavailable: "المساعد غير متاح حاليًا. حاول بعد قليل.",
  otp_required: "أدخل رمز التحقق المرسل إلى جوالك لمتابعة العمل.",
  demo_exists: "في المكتب بيانات تجريبية بالفعل. احذفها أولًا إن أردت البدء من جديد.",
  demo_in_use:
    "بعض سجلاتك الحقيقية (مهمة أو جلسة أو ملاحظة أو موعد أو مستند أو قضية أو فاتورة) مرتبطة ببيانات تجريبية. انقلها أو احذفها ثم أعد المحاولة.",
  call_limit: "وصلت إلى الحد المسموح من المكالمات (60 في الساعة لكل عضو، و200 يوميًا للمكتب). حاول لاحقًا.",
  voice_unavailable: "الاتصال من المتصفح غير متاح حاليًا لمكتبك.",
};
