    ...
    >
      ...
      <div className="relative z-10 flex min-h-[18rem] flex-col justify-center px-6 pt-14 pb-6 md:min-h-[26rem] md:px-16 md:pt-20 md:pb-8">
        <div className="mx-auto max-w-xl text-center">
          <h2 className="text-balance font-display text-[clamp(1.7rem,5vw,3.6rem)] font-semibold leading-tight text-snow [text-shadow:0_2px_0_var(--color-pine-deep),0_0_18px_color-mix(in_oklab,var(--color-pine-deep)_45%,transparent)]">
            حيث يبقى التأثير
          </h2>
