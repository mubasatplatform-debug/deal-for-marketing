...
export function Lawyers() {
  return (
    <section id="law" className="bg-ink">
      ...
      <Reveal className="flex flex-col items-center gap-4 px-8 py-16 text-center md:px-16">
        <ArrowLink href="/law">جرّب «مكتب المحامي» ١٤ يومًا مجانًا</ArrowLink>
        <ArrowLink href="/start/law">أو اطلب تنفيذه لمكتبك</ArrowLink>
      </Reveal>
    </section>
  );
}
